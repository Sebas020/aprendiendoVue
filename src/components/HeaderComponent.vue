<template>
    <header id="header">
        <div class="center">
            <!-- LOGO -->
            <div id="logo">
                <img src="../assets/logo.png" alt="Logotipo" class="app-logo">
                <span id="brand">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li>
                        <router-link :to="{name: 'pagina', params: {id: 'Soy el valor del parametro'}}" active-class="active">Pagina</router-link>
                    </li>
                    <li>
