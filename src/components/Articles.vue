<template>
  <section class="articles-component">
    <div id="articles-list" v-if="articles && articles.length >= 1">
      <article class="article-item" v-for="article in articles" :key="article._id">
        <div class="image-wrap">
          ...
          <img src="../assets/images/paisaje.jpg" :alt="article.title" v-if="!article.image" />
        </div>
        <h2>
    ...
    <div v-else-if="articles && articles.length < 1">No hay articulos para mostrar!!!</div>
